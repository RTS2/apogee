...
#include "ApnCamera.h" 
%}
%typemap(tcl,in) Apn_BayerShift = int;
%typemap(tcl,out) Apn_BayerShift = int;
...
%typemap(tcl,in) Apn_CoolerStatus_AtSetPoint = int;
%typemap(tcl,out) Apn_CoolerStatus_AtSetPoint = int;
%typemap(tcl,in) Apn_CoolerStatus_RampingToSetPoint = int;
%typemap(tcl,out) Apn_CoolerStatus_RampingToSetPoint = int;
...
%typemap(tcl,in) Apn_Platform = int;
%typemap(tcl,out) Apn_Platform = int;
%typemap(tcl,in) Apn_Resolution = int;
%typemap(tcl,out) Apn_Resolution = int;
%typemap(tcl,in) Apn_SerialParity = int;
%typemap(tcl,out) Apn_SerialParity = int;
...
%typemap(tcl,in) Camera_CoolerStatus_AtSetPoint = int;
%typemap(tcl,out) Camera_CoolerStatus_AtSetPoint = int;
%typemap(tcl,in) Camera_CoolerStatus_RampingToSetPoint = int;
%typemap(tcl,out) Camera_CoolerStatus_RampingToSetPoint = int;
